...
import ScrollManager from "@/app/components/ScroolComponent";
...
export default function ProjectPage({ params }: { params: { slug: string } }) {
	...
	return (
		<>
			<ScrollManager />
			<div className="w-full pt-20 pb-8 px-4 z-10">
				<div className="max-w-6xl mx-auto">
					...
					<div className="mb-12">
						<Image src={project.additionalImages[2]} alt={project.title} width={1200} height={675} className="w-full h-auto object-cover" />
					</div>
					{project.repository && (
						<div className="mb-12 text-center">
							<Link
								href={project.repository}
								className="bg-white text-primary px-6 py-2 text-lg hover:text-primary_hover transition-colors">
								Repositório
							</Link>
						</div>
					)}
